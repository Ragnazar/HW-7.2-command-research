...
public enum BotMessageEnum {
    ...
    START("Для дальнейшей работы выберите приют", "Главное меню"),

    CALL_VOLUNTEER("Ваш запрос важен для нас.", "Позвать волонтера"),
    ...
    TAKE_PASS("Вы запросили пропуск на въезд на территорию приюта\n" +
            "Для уточнения информации с вами свяжется волонтер приюта через телеграмм. Если вы хотите заказать звонок нажмите кнопку оставить данные\n\n" +
