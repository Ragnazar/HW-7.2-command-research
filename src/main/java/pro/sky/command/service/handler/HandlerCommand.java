...
public class HandlerCommand {
    ...
    public SendMessage handleMessage(Message message) {
        ...
        switch (command) {
            case "/start":
                ...
                return startCommand(chatId, messageId,message.getFrom().getFirstName());
            default:
    ...
    public SendMessage startCommand(Long chatId, int messageID, String name) {
        ...
        SendMessage message= service.sendMessage(chatId, answer);
        message.setReplyMarkup(InlineKeyboardMarkup.builder().keyboard( keyboardMaker.startKeyboard()).build());
        return message;
    }
}
